...
String restaurantListDataJsonString = json.encode(mockRestaurantList);

final mockRestaurantDetailData = {
  "error": false,
  "message": "success",
  "restaurant": {
    "id": "rqdv5juczeskfw1e867",
...
String restaurantDetailDataJsonString = json.encode(mockRestaurantDetailData);

final mockRestaurantSearchData = {
  "error": false,
  "founded": 1,
  "restaurants": [
    {
